...
// HeaderParam adds an HTTP request header parameter.
func (op *RouteOp) HeaderParam(name, description string, schema *Schema, required bool) *RouteOp {
	op.Operation.Parameters = append(op.Operation.Parameters, Parameter{
		Name: name, In: "header", Description: description, Required: required,
		Schema: &SchemaRef{Schema: schema},
	})
	return op
}
