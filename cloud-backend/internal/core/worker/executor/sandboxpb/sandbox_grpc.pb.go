...
func (c *sandboxServiceClient) Execute(ctx context.Context, in *ExecuteRequest, opts ...grpc.CallOption) (*ExecuteResult, error) {
...
func (UnimplementedSandboxServiceServer) Execute(context.Context, *ExecuteRequest) (*ExecuteResult, error) {
