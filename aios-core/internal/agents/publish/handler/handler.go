...
import (
	...
	"github.com/tangying-ai/aios-core/internal/agents/publish/service"
)
...
func bindPublishRequest(c *gin.Context) (service.PublishRequest, error) {
	if c.ContentType() == "application/json" {
		...
		if err := c.ShouldBindJSON(&request); err != nil {
			return service.PublishRequest{}, fmt.Errorf("failed to parse json: %w", err)
		}
		...
		if req.Title == "" || req.Description == "" {
			return service.PublishRequest{}, fmt.Errorf("title and description are required")
		}
		return req, nil
	}
	...
	if err := c.Request.ParseMultipartForm(32 << 20); err != nil {
		return service.PublishRequest{}, fmt.Errorf("failed to parse form: %w", err)
	}
