...
public class KafkaConfig {
    ...
    @Bean
    public ConsumerFactory<String, NodeTaskEvent> consumerFactory() {
        Map<String, Object> config = new HashMap<>();
        ...
        config.put(JsonDeserializer.VALUE_DEFAULT_TYPE, NodeTaskEvent.class.getName());
        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(),
            new JsonDeserializer<>(NodeTaskEvent.class, false));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, NodeTaskEvent> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, NodeTaskEvent> factory = new ConcurrentKafkaListenerContainerFactory<>();
