...
func hyperGenControlForAsset(asset *CharacterAsset) map[string]interface{} {
	control := map[string]interface{}{
		...
		"recommendedTimeline": []map[string]interface{}{
			...
			{"timeSec": 0, "channel": "bodySway", "value": "body_weight_shift"},
			{"timeSec": 0, "channel": "mouthOpen", "value": "bind_lip_sync_timeline"},
			{"timeSec": 0, "channel": "leftArmReach", "value": "bind_motion_timeline"},
			{"timeSec": 0, "channel": "rightArmReach", "value": "bind_motion_timeline"},
			{"timeSec": 0, "channel": "footBounce", "value": "bind_motion_timeline"},
		},
	}
